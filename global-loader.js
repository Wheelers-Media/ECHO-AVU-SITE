...
function loadHeader() {
      ...
      <div class="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
        ...
        <div class="hidden md:flex items-center gap-8">
          ...
          <a href="/marine-audio.html"
            class="text-sm font-medium text-gray-400 hover:text-white transition-colors duration-300">Marine & Powersports</a>
          <a href="/home-audio.html"
            class="text-sm font-medium text-gray-400 hover:text-white transition-colors duration-300">Home Audio & Hi-Fi</a>
          ...
          <div class="relative group">
            ...
            <!-- Dropdown Menu -->
            <div data-scroll-spotlight class="absolute right-0 mt-2 w-56 bg-carbon border border-edge rounded-lg shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 transform origin-top-right z-50">
              <div class="py-2">
        ...
        <div class="flex-1 overflow-y-auto px-6 pb-6">
          <nav class="space-y-8">
            ...
            <div class="space-y-4">
              ...
              <!-- SECTION 4: VISIT US (No Accordion) -->
  ...
  // Initialize mobile menu toggle logic AFTER injection
 ...
 * Sets up click handlers for the hamburger menu
 */
...
/**
 * LOAD FOOTER
 * Injects the 5-column footer into the DOM
 */
function loadFooter() {
  const footerHTML = `
    <!-- FOOTER -->
      ...
      <div class="max-w-7xl mx-auto px-6">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-16">
          ...
          <div>
            ...
            <ul class="space-y-3">
              <li><a href="/car-audio.html" class="text-gray-400 hover:text-echoRed transition-colors duration-200">Car Audio</a></li>
              <li><a href="/car-starters.html" class="text-gray-400 hover:text-echoRed transition-colors duration-200">Remote Car Starters</a></li>
              <li><a href="/marine-audio.html" class="text-gray-400 hover:text-echoRed transition-colors duration-200">Marine & Powersports</a></li>
              <li><a href="/home-audio.html" class="text-gray-400 hover:text-echoRed transition-colors duration-200">Home Audio & Hi-Fi</a></li>
              <li><a href="/tv-video.html" class="text-gray-400 hover:text-echoRed transition-colors duration-200">TV & Cinema</a></li>
              <li><a href="/surveillance.html" class="text-gray-400 hover:text-echoRed transition-colors duration-200">Surveillance</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul class="space-y-3">
              <li><a href="/services-residential.html" class="text-gray-400 hover:text-echoRed transition-colors duration-200">Residential Integration</a></li>
              <li><a href="/services-office.html" class="text-gray-400 hover:text-echoRed transition-colors duration-200">Office & Boardroom</a></li>
              <li><a href="/services-retail.html" class="text-gray-400 hover:text-echoRed transition-colors duration-200">Retail & Hospitality</a></li>
              <li><a href="/services-surveillance.html" class="text-gray-400 hover:text-echoRed transition-colors duration-200">Surveillance & Security</a></li>
              <li><a href="/services-car-audio.html" class="text-gray-400 hover:text-echoRed transition-colors duration-200">Vehicle Installations</a></li>
              <li><a href="/services-car-starters.html" class="text-gray-400 hover:text-echoRed transition-colors duration-200">Remote Car Starters</a></li>
              <li><a href="/services-marine.html" class="text-gray-400 hover:text-echoRed transition-colors duration-200">Marine & Powersports</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul class="space-y-3">
              <li><a href="/financing.html" class="text-gray-400 hover:text-echoRed transition-colors duration-200">Financing Application</a></li>
              <li><a href="/protection-plan.html" class="text-gray-400 hover:text-echoRed transition-colors duration-200">Guaranteed Protection</a></li>
              <li><a href="/return-policy.html" class="text-gray-400 hover:text-echoRed transition-colors duration-200">Return Policy</a></li>
              <li><a href="/privacy-statement.html" class="text-gray-400 hover:text-echoRed transition-colors duration-200">Privacy Statement</a></li>
              <li><a href="/brands.html" class="text-gray-400 hover:text-echoRed transition-colors duration-200">Our Brands</a></li>
            </ul>
          </div>

          <!-- COLUMN 5: VISIT US -->
          <div>
            <h4 class="text-white font-bold uppercase tracking-wider mb-6">Visit Us</h4>
            <ul class="space-y-3 mb-6">
              <li><a href="/about.html" class="text-gray-400 hover:text-echoRed transition-colors duration-200">About Echo AVU</a></li>
              <li><a href="/dream-home.html" class="text-gray-400 hover:text-echoRed transition-colors duration-200">Rotary Dream Home</a></li>
              <li><a href="/contact.html" class="text-gray-400 hover:text-echoRed transition-colors duration-200">Contact Support</a></li>
            </ul>
            <div class="h-px bg-white/10 w-full mb-6"></div>
            <div class="space-y-4">
              <div>
                <p class="text-gray-300">11101 100 St, Grande Prairie, AB T8V 2N2</p>
                <a href="https://maps.google.com/?q=11101+100+St,+Grande+Prairie,+AB+T8V+2N2" target="_blank"
                  class="inline-block mt-2 text-echoRed font-bold text-sm tracking-wide uppercase hover:text-white transition-colors">
                  Get Directions
                </a>
              ...
              <a href="tel:7805381333"
                class="block text-2x1font-heading font-bold text-white hover:text-echoRed transition-colors">(780) 538-1333</a>
            </div>
          </div>
        ...
        <div class="border-t border-edge pt-8">
          <div class="flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-gray-600">
            <p class="text-center">&copy; 2026 Echo Audio Video Unlimited. All rights reserved.</p>
 ...
 * Detects the current page and highlights it in the navigation
 */
function highlightActivePage() {
  ...
  navLinks.forEach(link => {
    ...
    // Extract filename from href (handle both absolute and relative paths)
    ...
    if (linkPage === currentPage || (currentPage === '' && linkPage === 'index.html')) {
      ...
      // For mobile menu items, also make them bolder
